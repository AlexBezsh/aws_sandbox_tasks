...
import com.task11.handlers.GetReservationsHandler;
import com.task11.handlers.GetTableByIdHandler;
import com.task11.handlers.GetTablesHandler;
import com.task11.handlers.PostReservationsHandler;
import com.task11.handlers.PostSignInHandler;
import com.task11.handlers.PostSignupHandler;
import com.task11.handlers.PostTablesHandler;
...
public class ApiHandler implements RequestHandler<APIGatewayProxyRequestEvent,
    ...
    private static final Map<String, String> headersForCORS = initHeadersForCORS();
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        return HANDLERS.entrySet().stream()
            ...
            .map(response -> response.withHeaders(headersForCORS))
            .findFirst()
    ...
    private static Map<String, String> initHeadersForCORS() {
        return Map.of(
